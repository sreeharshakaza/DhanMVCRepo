...
namespace MVCEntityDemo
{
    ...
    /// </summary>
    public partial class DhanMVCDemoEntities : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new DhanMVCDemoEntities object using the connection string found in the 'DhanMVCDemoEntities' section of the application configuration file.
        /// </summary>
        public DhanMVCDemoEntities() : base("name=DhanMVCDemoEntities", "DhanMVCDemoEntities")
        {
        ...
        /// <summary>
        /// Initialize a new DhanMVCDemoEntities object.
        /// </summary>
        public DhanMVCDemoEntities(string connectionString) : base(connectionString, "DhanMVCDemoEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new DhanMVCDemoEntities object.
        /// </summary>
        public DhanMVCDemoEntities(EntityConnection connection) : base(connection, "DhanMVCDemoEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="DhanMVCDemoModel", Name="Student")]
    [Serializable()]
